from multinomial_decoder import MultinomialDecode
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, 6250, eta_min=0, last_epoch=- 1, verbose=False)

scaler = torch.cuda.amp.GradScaler()

checkpoint = torch.load("content/checkpoint_baseline_final.pth")
